...
void setup() {
  ...
  for (int i=0; i<stories.size(); i++) {
    ...
    //saveJSONObject(stories.get(i), "data/storyByTime.json", "compact");
  }
  ...
  for (int i=0; i<stories.size(); i++) {
    arr.append(stories.get(i));
    //saveJSONObject(stories.get(i), "data/storyByScore.json", "compact");
  }
  ...
  for (int i=0; i<stories.size(); i++) {
    arr.append(stories.get(i));
    //saveJSONObject(stories.get(i), "data/storyByKids.json", "compact");
  }
